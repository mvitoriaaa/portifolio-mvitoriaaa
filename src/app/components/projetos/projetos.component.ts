  ...
  projetos = [
    {
      ...
      desc: 'Sistema completo para controle de frota: cadastro de veículos, histórico de manutenções, relatórios gerenciais e controle de motoristas.',
    ...
    },
    {
      ...
      desc: 'Solução de monitoramento em tempo real do consumo energético de servidores. Dashboards Grafana integrados com Zabbix para métricas e alertas críticos.',
    ...
    },
    {
      ...
      desc: 'Projetos acadêmicos ao longo dos 5 períodos: estruturas de dados, algoritmos, banco de dados e desenvolvimento web.',
